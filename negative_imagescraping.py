...
def store_raw_images():
    neg_images_link = 'http://image-net.org/api/text/imagenet.synset.geturls?wnid=n10639817'   
    ...
    for i in neg_image_urls.split('\n'):
        try:
            ...
            # should be larger than samples / neg pic (so we can place our image on it)
